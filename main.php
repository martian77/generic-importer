...
//    $output_connection->writeData( __DIR__ . '/test.csv', $data, $write_settings);
    $import_connection = $gi->fetchConnection( Settings::getSetting('input_location.type'));
    $import_data = $import_connection->readData( Settings::getSetting('input_location.file_location'), ['read_headers' => 0] );
